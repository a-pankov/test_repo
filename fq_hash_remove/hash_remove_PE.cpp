...
int main(int argc, char ** argv)
{
  ...
  while (fastQFile_1.keepReadingFile() && fastQFile_2.keepReadingFile() && ++total_all)
  {
    ...
    if(fastQFile_1.readFastQSequence() == FastQStatus::FASTQ_SUCCESS && fastQFile_2.readFastQSequence() == FastQStatus::FASTQ_SUCCESS){
      ...
      for(;start_1 != end_1 && (fastQFile_1.myQualityString[start_1] == '#'); ++start_1){}
      if(start_1 == end_1) continue;
      else {
        
        for(;start_2 != end_2 && (fastQFile_2.myQualityString[start_2] == '#'); ++start_2){}
        if(start_2 == end_2) continue;
        else {
          --end_2;
          for(;end_2 != start_2 && (fastQFile_2.myQualityString[end_2] == '#'); --end_2){}
...
//rout_2.flush();
          ...
          --end_1;
          for(;end_1 != start_1 && (fastQFile_1.myQualityString[end_1] == '#'); --end_1){}
